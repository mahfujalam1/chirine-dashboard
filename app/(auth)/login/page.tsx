    ...
    return (
        <div className="flex h-screen w-full p-4">
            <div className="rounded-lg overflow-hidden border border-border p-2 flex gap-4 w-full">
                {/* <div className="hidden md:inline-block bg-radial-[at_25%_25%] from-[#FBE25E]/50 to-[#00ACA7]/50  to-75% p-12 w-1/2 rounded-xl overflow-hidden">
                    <img className="h-full w-full aspect-square object-contain" src="/brand.svg" alt="brand" />
                </div> */}
